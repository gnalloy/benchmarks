...
func benchmarkName(protocol string) string {
	if protocol == protocolHTTPS1 {
		return "BenchmarkFastHTTPHTTPS1"
	}
	return "BenchmarkFastHTTPHTTP1"
}
