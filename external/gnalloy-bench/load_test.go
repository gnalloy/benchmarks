...
func TestRunBenchmarkTCPEchoReadCompleteMode(t *testing.T) {
	cfg, err := parseConfig([]string{
		"-protocol", "tcp-echo",
		"-tcp-echo-mode", "read-complete",
		"-addr", "127.0.0.1:0",
		"-payload", "16",
		"-connections", "1",
		"-messages", "2",
...
func TestRunBenchmarkTCPEchoOwnerExecutorMode(t *testing.T) {
	cfg, err := parseConfig([]string{
		"-protocol", "tcp-echo",
		"-tcp-echo-mode", "owner-executor",
		"-tcp-echo-executor-workers", "1",
		"-tcp-echo-executor-queue-size", "8",
		"-addr", "127.0.0.1:0",
		"-payload", "16",
		"-connections", "1",
		"-messages", "2",
